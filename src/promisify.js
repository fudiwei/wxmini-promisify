...
const promisyFuncs = [
    ...
    'pluginLogin', 'login', 'checkSession',
    ...
    'requestSubscribeMessage', 'requestSubscribeSystemMessage', 'requestSubscribeDeviceMessage',
    // 开放接口：微信红包 - OpenAPI/RedPackage
    'showRedPackage',
    // 开放接口：收藏 - OpenAPI/Favorites
    'addVideoToFavorites', 'addFileToFavorites',
    // 开放接口：视频号 - OpenAPI/Channels
    'openChannelsUserProfile', 'openChannelsLive', 'openChannelsEvent', 'openChannelsActivity', 'getChannelsLiveNoticeInfo', 'getChannelsLiveInfo',
